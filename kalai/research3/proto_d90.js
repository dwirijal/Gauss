...
function runSymbol(sym) {
  const m5 = load(`research3/m5_${sym}.json`);
  const h1 = load(`research3/h1_${sym}.json`);
...
const m5 = load('research3/m5_BTCUSDT.json');
...
fs.writeFileSync('research3/htf_90d.json', JSON.stringify(out, null, 2));
