...
/** Mainnet API URL. */ export const MAINNET_API_URL = "https://api.hyperliquid.xyz";
/** Testnet API URL. */ export const TESTNET_API_URL = "https://api.hyperliquid-testnet.xyz";
/** Mainnet RPC URL. */ export const MAINNET_RPC_URL = "https://rpc.hyperliquid.xyz";
/** Testnet RPC URL. */ export const TESTNET_RPC_URL = "https://rpc.hyperliquid-testnet.xyz";
/**
 ...
 */ export class HttpRequestError extends TransportError {
   ...
   */ constructor(options){
    ...
    if (response) {
      ...
      message = cause === undefined ? "Unknown HTTP request error" : `Unknown HTTP request error: ${cause instanceof Error ? cause.message : String(cause)}`;
    }
...
// Helpers
// =============================================================================
/** Truncates `text` to `limit` characters, appending the original length. */ function truncate(text, limit = 1024) {
