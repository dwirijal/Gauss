...
/** Thrown when canonicalization fails due to schema/data key mismatch. */ export class CanonicalizeError extends HyperliquidError {
  constructor(message){
    super(message);
 ...
 * });
 * ```
 */ export function canonicalize(schema, value) {
