 ...
 * @module
 */ import { getWalletAddress, signTypedData } from "./_abstractWallet.js";
import { createL1ActionHash, signL1Inner } from "./_l1.js";
import { signUserSignedInner } from "./_userSigned.js";
/** EIP-712 types for the multi-sig outer wrapper. */ const MULTI_SIG_TYPES = {
...
/** Removes leading zeros from signature `r` and `s` (required for multi-sig signatures). */ export function trimSignature(sig) {
  return {
...
//# sourceMappingURL=_multiSig.js.map
