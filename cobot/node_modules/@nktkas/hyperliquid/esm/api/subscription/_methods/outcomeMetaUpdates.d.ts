 ...
 */
export declare const OutcomeMetaUpdatesRequest: v.ObjectSchema<{
    /** Type of subscription. */
    readonly type: v.LiteralSchema<"outcomeMetaUpdates", undefined>;
}, undefined>;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */
export declare function outcomeMetaUpdates(config: SubscriptionConfig, listener: (data: OutcomeMetaUpdatesEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
