 ...
 */ export const UserTwapHistoryRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("userTwapHistory"),
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function userTwapHistory(config, params, listener, options) {
  const payload = parse(UserTwapHistoryRequest, {
