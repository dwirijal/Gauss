 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */
export declare function userFills(config: SubscriptionConfig, params: UserFillsParameters, listener: (data: UserFillsEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
