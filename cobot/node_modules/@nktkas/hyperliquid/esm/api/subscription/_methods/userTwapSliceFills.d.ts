 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */
export declare function userTwapSliceFills(config: SubscriptionConfig, params: UserTwapSliceFillsParameters, listener: (data: UserTwapSliceFillsEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
