 ...
 */ export const ActiveSpotAssetCtxRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("activeAssetCtx"),
    /** Asset ID (e.g., @1). */ coin: v.string()
  });
})();
// ============================================================
// Execution Logic
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function activeSpotAssetCtx(config, params, listener, options) {
  const payload = parse(ActiveSpotAssetCtxRequest, {
    type: "activeAssetCtx",
    ...params
  });
