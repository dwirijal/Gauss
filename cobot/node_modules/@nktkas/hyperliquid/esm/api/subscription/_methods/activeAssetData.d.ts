 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */
export declare function activeAssetData(config: SubscriptionConfig, params: ActiveAssetDataParameters, listener: (data: ActiveAssetDataEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
