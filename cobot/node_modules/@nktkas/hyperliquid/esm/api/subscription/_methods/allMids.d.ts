 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */
export declare function allMids(config: SubscriptionConfig, listener: (data: AllMidsEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
export declare function allMids(config: SubscriptionConfig, params: AllMidsParameters, listener: (data: AllMidsEvent) => void, options?: SubscriptionOptions): Promise<ISubscription>;
