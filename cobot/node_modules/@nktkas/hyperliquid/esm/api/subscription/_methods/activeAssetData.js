 ...
 */ export const ActiveAssetDataRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("activeAssetData"),
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function activeAssetData(config, params, listener, options) {
  const payload = parse(ActiveAssetDataRequest, {
