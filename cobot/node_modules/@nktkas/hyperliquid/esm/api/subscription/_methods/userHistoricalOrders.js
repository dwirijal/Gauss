 ...
 */ export const UserHistoricalOrdersRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("userHistoricalOrders"),
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function userHistoricalOrders(config, params, listener, options) {
  const payload = parse(UserHistoricalOrdersRequest, {
