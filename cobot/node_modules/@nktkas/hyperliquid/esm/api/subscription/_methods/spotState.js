 ...
 */ export const SpotStateRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("spotState"),
    /** User address. */ user: Address,
    /** Whether to ignore portfolio margin calculations. */ ignorePortfolioMargin: v.optional(v.boolean())
  });
})();
// ============================================================
// Execution Logic
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function spotState(config, params, listener, options) {
  const payload = parse(SpotStateRequest, {
    type: "spotState",
    ...params
  });
