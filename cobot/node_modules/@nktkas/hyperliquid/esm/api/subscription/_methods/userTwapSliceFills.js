 ...
 */ export const UserTwapSliceFillsRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Type of subscription. */ type: v.literal("userTwapSliceFills"),
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/websocket/subscriptions
 */ export function userTwapSliceFills(config, params, listener, options) {
  const payload = parse(UserTwapSliceFillsRequest, {
