 ...
 */
export declare const PerpConciseAnnotationsRequest: v.ObjectSchema<{
    /** Type of request. */
    readonly type: v.LiteralSchema<"perpConciseAnnotations", undefined>;
}, undefined>;
 ...
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/info-endpoint/perpetuals#retrieve-concise-perp-annotations
 */
export declare function perpConciseAnnotations(config: InfoConfig, signal?: AbortSignal): Promise<PerpConciseAnnotationsResponse>;
