 ...
 */ export const TwapCancelRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("twapCancel"),
...
/** Schema for action fields (excludes request-level system fields). */ const TwapCancelActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function twapCancel(config, params, opts) {
  const action = canonicalize(TwapCancelActionSchema, parse(TwapCancelActionSchema, {
    type: "twapCancel",
    ...params
  }));
