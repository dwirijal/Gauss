 ...
 */ export const ApproveAgentRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("approveAgent"),
      ...
      /** Agent name (min 1 and max 16 characters) or empty string for unnamed agent. */ agentName: v.nullish(v.pipe(v.string(), v.check((input)=>{
...
/** Schema for action fields (excludes request-level system fields). */ const ApproveAgentActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode approveAgent} function. */ export const ApproveAgentTypes = {
 ...
 */ export function approveAgent(config, params, opts) {
  const action = canonicalize(ApproveAgentActionSchema, parse(ApproveAgentActionSchema, {
    type: "approveAgent",
    ...params
  }));
