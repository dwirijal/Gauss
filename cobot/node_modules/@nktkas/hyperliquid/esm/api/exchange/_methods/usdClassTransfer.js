 ...
 */ export const UsdClassTransferRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("usdClassTransfer"),
      ...
      /** `true` for spot to perp, `false` for perp to spot. */ toPerp: v.boolean(),
...
/** Schema for action fields (excludes request-level system fields). */ const UsdClassTransferActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode usdClassTransfer} function. */ export const UsdClassTransferTypes = {
 ...
 */ export function usdClassTransfer(config, params, opts) {
  const action = canonicalize(UsdClassTransferActionSchema, parse(UsdClassTransferActionSchema, {
