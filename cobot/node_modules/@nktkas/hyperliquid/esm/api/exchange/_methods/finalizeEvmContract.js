 ...
 */ export const FinalizeEvmContractRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("finalizeEvmContract"),
       ...
       */ input: v.union([
        v.object({
          /** Use the EVM deployment nonce of an EOA-deployed contract. */ create: v.object({
...
/** Schema for action fields (excludes request-level system fields). */ const FinalizeEvmContractActionSchema = /* @__PURE__ */ (()=>{
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/hyperevm/hypercore-less-than-greater-than-hyperevm-transfers
 */ export function finalizeEvmContract(config, params, opts) {
  const action = canonicalize(FinalizeEvmContractActionSchema, parse(FinalizeEvmContractActionSchema, {
