 ...
 */ export const ModifyRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("modify"),
...
/** Schema for action fields (excludes request-level system fields). */ const ModifyActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function modify(config, params, opts) {
  const action = canonicalize(ModifyActionSchema, parse(ModifyActionSchema, {
    type: "modify",
    ...params
  }));
