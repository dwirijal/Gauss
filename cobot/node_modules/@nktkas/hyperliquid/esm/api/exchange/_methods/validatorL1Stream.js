 ...
 */ export const ValidatorL1StreamRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("validatorL1Stream"),
...
/** Schema for action fields (excludes request-level system fields). */ const ValidatorL1StreamActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function validatorL1Stream(config, params, opts) {
  const action = canonicalize(ValidatorL1StreamActionSchema, parse(ValidatorL1StreamActionSchema, {
