 ...
 */ export const UserPortfolioMarginRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("userPortfolioMargin"),
      ...
      /** Whether to enable or disable user portfolio margin. */ enabled: v.boolean(),
...
/** Schema for action fields (excludes request-level system fields). */ const UserPortfolioMarginActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode userPortfolioMargin} function. */ export const UserPortfolioMarginTypes = {
 ...
 */ export function userPortfolioMargin(config, params, opts) {
  const action = canonicalize(UserPortfolioMarginActionSchema, parse(UserPortfolioMarginActionSchema, {
