 ...
 */ export const ApproveBuilderFeeRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("approveBuilderFee"),
...
/** Schema for action fields (excludes request-level system fields). */ const ApproveBuilderFeeActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode approveBuilderFee} function. */ export const ApproveBuilderFeeTypes = {
 ...
 */ export function approveBuilderFee(config, params, opts) {
  const action = canonicalize(ApproveBuilderFeeActionSchema, parse(ApproveBuilderFeeActionSchema, {
