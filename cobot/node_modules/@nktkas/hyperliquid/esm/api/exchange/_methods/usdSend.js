 ...
 */ export const UsdSendRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("usdSend"),
...
/** Schema for action fields (excludes request-level system fields). */ const UsdSendActionSchema = /* @__PURE__ */ (()=>{
  return v.omit(v.object(UsdSendRequest.entries.action.entries), [
    "signatureChainId",
    "hyperliquidChain",
    "time"
  ]);
})();
/** EIP-712 types for the {@linkcode usdSend} function. */ export const UsdSendTypes = {
 ...
 */ export function usdSend(config, params, opts) {
  const action = canonicalize(UsdSendActionSchema, parse(UsdSendActionSchema, {
    type: "usdSend",
    ...params
  }));
