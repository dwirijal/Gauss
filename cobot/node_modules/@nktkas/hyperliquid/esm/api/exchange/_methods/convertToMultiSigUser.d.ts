...
declare const ConvertToMultiSigUserActionSchema: Omit<v.ObjectSchema<{
    ...
    readonly "~run": (dataset: v.UnknownDataset, config: v.Config<v.BaseIssue<unknown>>) => v.OutputDataset<{
        type: "convertToMultiSigUser";
        signers: string;
    }, v.ArrayIssue | v.ObjectIssue | v.LiteralIssue | v.NumberIssue | v.StringIssue | v.UnionIssue<v.NumberIssue | v.StringIssue> | v.RegexIssue<string> | v.ToNumberIssue<string | number> | v.SafeIntegerIssue<number> | v.MinValueIssue<number, 0> | v.LengthIssue<`0x${string}`, 42> | v.MinValueIssue<number, 1> | v.MaxValueIssue<number, 10> | v.ParseJsonIssue<string> | v.StringifyJsonIssue<{
        authorizedUsers: `0x${string}`[];
        threshold: number;
    } | null> | v.UnionIssue<v.ArrayIssue | v.ObjectIssue | v.NumberIssue | v.StringIssue | v.UnionIssue<v.NumberIssue | v.StringIssue> | v.RegexIssue<string> | v.ToNumberIssue<string | number> | v.SafeIntegerIssue<number> | v.MinValueIssue<number, 0> | v.LengthIssue<`0x${string}`, 42> | v.MinValueIssue<number, 1> | v.MaxValueIssue<number, 10> | v.ParseJsonIssue<string> | v.StringifyJsonIssue<{
        authorizedUsers: `0x${string}`[];
        threshold: number;
    } | null>>>;
    readonly "~types"?: {
        ...
        readonly issue: v.ArrayIssue | v.ObjectIssue | v.LiteralIssue | v.NumberIssue | v.StringIssue | v.UnionIssue<v.NumberIssue | v.StringIssue> | v.RegexIssue<string> | v.ToNumberIssue<string | number> | v.SafeIntegerIssue<number> | v.MinValueIssue<number, 0> | v.LengthIssue<`0x${string}`, 42> | v.MinValueIssue<number, 1> | v.MaxValueIssue<number, 10> | v.ParseJsonIssue<string> | v.StringifyJsonIssue<{
            authorizedUsers: `0x${string}`[];
            threshold: number;
        } | null> | v.UnionIssue<v.ArrayIssue | v.ObjectIssue | v.NumberIssue | v.StringIssue | v.UnionIssue<v.NumberIssue | v.StringIssue> | v.RegexIssue<string> | v.ToNumberIssue<string | number> | v.SafeIntegerIssue<number> | v.MinValueIssue<number, 0> | v.LengthIssue<`0x${string}`, 42> | v.MinValueIssue<number, 1> | v.MaxValueIssue<number, 10> | v.ParseJsonIssue<string> | v.StringifyJsonIssue<{
            authorizedUsers: `0x${string}`[];
