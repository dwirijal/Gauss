 ...
 */ export const LinkStakingUserRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("linkStakingUser"),
...
/** Schema for action fields (excludes request-level system fields). */ const LinkStakingUserActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode linkStakingUser} function. */ export const LinkStakingUserTypes = {
 ...
 */ export function linkStakingUser(config, params, opts) {
  const action = canonicalize(LinkStakingUserActionSchema, parse(LinkStakingUserActionSchema, {
