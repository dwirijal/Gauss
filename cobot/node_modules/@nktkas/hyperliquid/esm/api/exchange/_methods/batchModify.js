 ...
 */ export const BatchModifyRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("batchModify"),
      /** Order modifications. */ modifies: v.array(v.object({
        /** Order ID or Client Order ID. */ oid: v.union([
          UnsignedInteger,
          Cloid
        ]),
        /** New order parameters. */ order: v.object({
...
/** Schema for action fields (excludes request-level system fields). */ const BatchModifyActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function batchModify(config, params, opts) {
  const action = canonicalize(BatchModifyActionSchema, parse(BatchModifyActionSchema, {
    type: "batchModify",
    ...params
  }));
