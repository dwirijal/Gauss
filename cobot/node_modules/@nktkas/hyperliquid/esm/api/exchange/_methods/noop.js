 ...
 */ export const NoopRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("noop")
    }),
...
/** Schema for action fields (excludes request-level system fields). */ const NoopActionSchema = /* @__PURE__ */ (()=>{
 ...
 *
 * @see https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/exchange-endpoint#invalidate-pending-nonce-noop
 */ export function noop(config, params, opts) {
  const action = canonicalize(NoopActionSchema, parse(NoopActionSchema, {
    type: "noop"
  }));
