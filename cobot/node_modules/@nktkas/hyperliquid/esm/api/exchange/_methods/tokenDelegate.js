 ...
 */ export const TokenDelegateRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("tokenDelegate"),
      ...
      /** Amount for delegate/undelegate (float * 1e8). */ wei: v.pipe(UnsignedInteger, v.minValue(1)),
      /** `true` for undelegate, `false` for delegate. */ isUndelegate: v.boolean(),
...
/** Schema for action fields (excludes request-level system fields). */ const TokenDelegateActionSchema = /* @__PURE__ */ (()=>{
...
/** EIP-712 types for the {@linkcode tokenDelegate} function. */ export const TokenDelegateTypes = {
 ...
 */ export function tokenDelegate(config, params, opts) {
  const action = canonicalize(TokenDelegateActionSchema, parse(TokenDelegateActionSchema, {
    type: "tokenDelegate",
    ...params
  }));
