 ...
 */ export const CancelByCloidRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("cancelByCloid"),
      /** Orders to cancel by asset and client order ID. */ cancels: v.array(v.object({
        /** Asset ID. */ asset: UnsignedInteger,
        /** Client Order ID. */ cloid: Cloid
      })),
      /** Prioritize this cancel in the mempool (fast cancel). */ f: v.optional(v.literal(true))
    }),
...
/** Schema for action fields (excludes request-level system fields). */ const CancelByCloidActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function cancelByCloid(config, params, opts) {
  const action = canonicalize(CancelByCloidActionSchema, parse(CancelByCloidActionSchema, {
    type: "cancelByCloid",
    ...params
  }));
