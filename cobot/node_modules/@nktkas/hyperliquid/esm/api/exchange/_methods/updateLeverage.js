 ...
 */ export const UpdateLeverageRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("updateLeverage"),
      /** Asset ID. */ asset: UnsignedInteger,
      /** `true` for cross leverage, `false` for isolated leverage. */ isCross: v.boolean(),
      /** New leverage value. */ leverage: v.pipe(UnsignedInteger, v.minValue(1))
    }),
...
/** Schema for action fields (excludes request-level system fields). */ const UpdateLeverageActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function updateLeverage(config, params, opts) {
  const action = canonicalize(UpdateLeverageActionSchema, parse(UpdateLeverageActionSchema, {
    type: "updateLeverage",
    ...params
  }));
