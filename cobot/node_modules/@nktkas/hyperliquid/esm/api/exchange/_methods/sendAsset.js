 ...
 */ export const SendAssetRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("sendAsset"),
...
/** Schema for action fields (excludes request-level system fields). */ const SendAssetActionSchema = /* @__PURE__ */ (()=>{
  return v.omit(v.object(SendAssetRequest.entries.action.entries), [
    "signatureChainId",
    "hyperliquidChain",
    "nonce"
  ]);
})();
/** EIP-712 types for the {@linkcode sendAsset} function. */ export const SendAssetTypes = {
 ...
 */ export function sendAsset(config, params, opts) {
  const action = canonicalize(SendAssetActionSchema, parse(SendAssetActionSchema, {
    type: "sendAsset",
    ...params
  }));
