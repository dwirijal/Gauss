 ...
 */ export const SpotSendRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("spotSend"),
...
/** Schema for action fields (excludes request-level system fields). */ const SpotSendActionSchema = /* @__PURE__ */ (()=>{
  return v.omit(v.object(SpotSendRequest.entries.action.entries), [
    "signatureChainId",
    "hyperliquidChain",
    "time"
  ]);
})();
/** EIP-712 types for the {@linkcode spotSend} function. */ export const SpotSendTypes = {
 ...
 */ export function spotSend(config, params, opts) {
  const action = canonicalize(SpotSendActionSchema, parse(SpotSendActionSchema, {
    type: "spotSend",
    ...params
  }));
