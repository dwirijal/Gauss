 ...
 */ export const SubAccountSpotTransferRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("subAccountSpotTransfer"),
      /** Sub-account address. */ subAccountUser: Address,
      /** `true` for deposit, `false` for withdrawal. */ isDeposit: v.boolean(),
...
/** Schema for action fields (excludes request-level system fields). */ const SubAccountSpotTransferActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function subAccountSpotTransfer(config, params, opts) {
  const action = canonicalize(SubAccountSpotTransferActionSchema, parse(SubAccountSpotTransferActionSchema, {
