 ...
 */ export const RegisterReferrerRequest = /* @__PURE__ */ (()=>{
  return v.object({
    /** Action to perform. */ action: v.object({
      /** Type of action. */ type: v.literal("registerReferrer"),
      /** Referral code to create. */ code: v.pipe(v.string(), v.minLength(1), v.maxLength(20))
    }),
...
/** Schema for action fields (excludes request-level system fields). */ const RegisterReferrerActionSchema = /* @__PURE__ */ (()=>{
 ...
 */ export function registerReferrer(config, params, opts) {
  const action = canonicalize(RegisterReferrerActionSchema, parse(RegisterReferrerActionSchema, {
